...
const TESTMODE =
  ...
  window.location &&
  window.location.href.toLowerCase().indexOf('http://localhost:8000/') > -1
const COMPRESS = true // TEST: `compression` write prop

// CONST
const CUST_NAME = 'S.T.A.R. Laboratories'
const USER_NAME = 'Barry Allen'
const ARRSTRBITES = [130]
const CHARSPERLINE = 130 // 'Open Sans', 13px, 900px-colW = ~19 words/line ~130 chars/line

// TABLES
const TABLE_NAMES_F = ['Markiplier', 'Jack', 'Brian', 'Paul', 'Ev', 'Ann', 'Michelle', 'Jenny', 'Lara', 'Kathryn']
const TABLE_NAMES_L = [
  'Johnson',
  'Septiceye',
  'Lapston',
...
// OPTIONS
const BASE_TEXT_OPTS_L = { color: '9F9F9F', margin: 3, border: [null, null, { pt: '1', color: 'CFCFCF' }, null] }
...
const DEMO_TITLE_TEXTBK = { fontSize: 14, color: '0088CC', bold: true, breakLine: true }
...
const IMAGE_PATHS = {
  ...
  chicagoBean: {
    path:
      'https://raw.githubusercontent.com/gitbrent/PptxGenJS/master/demos/common/images/chicago_bean_bohne.jpg?op=paramTest&ampersandTest',
  },
  sydneyBridge: {
    path:
  ...
  video_mp4_thumb: {
    path: 'https://raw.githubusercontent.com/gitbrent/PptxGenJS/master/demos/common/images/video-mp4-thumb.png',
  },
}

// LOREM IPSUM
const LOREM_IPSUM_ENG =
