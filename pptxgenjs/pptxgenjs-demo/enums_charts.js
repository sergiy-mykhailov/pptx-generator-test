...
const COLORS_RYGU = [COLOR_RED, COLOR_YLW, COLOR_GRN, COLOR_COMP, COLOR_CANC, COLOR_UNK]
//
const COLORS_ACCENT = ['4472C4', 'ED7D31', 'FFC000', '70AD47'] // 1,2,4,6
...
const CHART_DATA = {
  ...
  LongTermIntRates: {
    ...
    chartData: [
      {
        name: 'Canada',
        labels: INTRATES_LBLS,
        values: [4.27, 3.61, 3.23, 3.24, 2.78, 1.87, 2.26, 2.23, 1.52, 1.25, 1.78, 2.28, 1.59, 0.75],
      },
      {
        name: 'France',
        labels: INTRATES_LBLS,
        values: [4.3, 4.23, 3.65, 3.12, 3.32, 2.54, 2.2, 1.67, 0.84, 0.47, 0.81, 0.78, 0.13, -0.15],
      },
      {
        name: 'Germany',
        labels: INTRATES_LBLS,
        values: [4.22, 3.98, 3.22, 2.74, 2.61, 1.5, 1.57, 1.16, 0.5, 0.09, 0.32, 0.4, -0.25, -0.51],
      },
      {
        name: 'Italy',
        labels: INTRATES_LBLS,
        values: [4.49, 4.68, 4.31, 4.04, 5.42, 5.49, 4.32, 2.89, 1.71, 1.49, 2.11, 2.61, 1.95, 1.17],
      },
      {
        name: 'Japan',
        labels: INTRATES_LBLS,
        values: [1.67, 1.47, 1.33, 1.15, 1.1, 0.84, 0.69, 0.52, 0.35, -0.07, 0.05, 0.07, -0.11, -0.01],
      },
      {
        name: 'United Kingdom',
        labels: INTRATES_LBLS,
        values: [5.01, 4.59, 3.65, 3.62, 3.14, 1.92, 2.39, 2.57, 1.9, 1.31, 1.24, 1.46, 0.94, 0.37],
      },
      {
        name: 'United States',
        labels: INTRATES_LBLS,
        values: [4.63, 3.67, 3.26, 3.21, 2.79, 1.8, 2.35, 2.54, 2.14, 1.84, 2.33, 2.91, 2.14, 0.89],
      },
    ],
  },
  CeoPayRatio_Both: {
