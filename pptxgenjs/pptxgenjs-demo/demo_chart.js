...
const {
  ...
  dataChartPieLocs,
  dataChartPieStat,
} = require('./enums_charts')

function genSlidesChart(pptx) {
...
function genSlide01(pptx) {
  ...
  slide.addTable(
    [[{ text: 'Chart Options: Chart Title, Cat/Val Axis Title', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
...
function genSlide02(pptx) {
  ...
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html')
  slide.addTable(
    [[{ text: 'Chart Examples: Bar Chart', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
...
function genSlide03(pptx) {
  ...
  slide.addTable(
    [
      [
        { text: 'Chart Examples: Bar Chart Options: Axis, DataLabel, Grid', options: BASE_TEXT_OPTS_L },
        BASE_TEXT_OPTS_R,
      ],
    ],
    BASE_TABLE_OPTS,
...
function genSlide04(pptx) {
  ...
  slide.addTable(
    [
      [
        { text: 'Chart Examples: Bar Chart: Stacked/PercentStacked and DataTable', options: BASE_TEXT_OPTS_L },
        BASE_TEXT_OPTS_R,
      ],
    ],
    BASE_TABLE_OPTS,
...
function genSlide06(pptx) {
  ...
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html')
  slide.addTable(
    [[{ text: 'Chart Examples: 3D Bar Chart', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
...
function genSlide07(pptx) {
  ...
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html')
  slide.addTable(
    [[{ text: 'Tornado Chart - Grid and Axis Formatting', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
...
function genSlide08(pptx) {
  ...
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html')
  slide.addTable(
    [[{ text: 'Chart Examples: Line Chart', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
...
function genSlide09(pptx) {
  ...
  slide.addTable(
    [
      [
        { text: 'Chart Examples: Line Smoothing, Line Size, Line Shadow, Symbol Size', options: BASE_TEXT_OPTS_L },
        BASE_TEXT_OPTS_R,
      ],
    ],
    BASE_TABLE_OPTS,
  ...
  const shadowOpts = { type: 'outer', color: 'cd0011', blur: 3, offset: 12, angle: 75, opacity: 0.8 }
...
function genSlide10(pptx) {
  ...
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html')
  slide.addTable(
    [[{ text: 'Chart Examples: Line Chart: lineDataSymbol options', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
...
function genSlide11(pptx) {
  ...
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html')
  slide.addTable(
    [[{ text: 'Chart Examples: Area Chart, Stacked Area Chart', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
  ...
  // BOTTOM-RIGHT
  const optsChartLine4 = { x: 7, y: 4.0, w: '45%', h: 3, chartColors: ['CC8833', 'CCFF69'], chartColorsOpacity: 75 }
...
function genSlide12(pptx) {
  ...
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html')
  slide.addTable(
    [[{ text: 'Chart Examples: Pie Charts: Legends', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
...
function genSlide13(pptx) {
  ...
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html')
  slide.addTable(
    [[{ text: 'Chart Examples: Doughnut Chart', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
...
function genSlide14(pptx) {
  ...
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html')
  slide.addTable(
    [[{ text: 'Chart Examples: XY Scatter Chart', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
  ...
  // BOTTOM-RIGHT
  const optsChartScat4 = { x: 7.0, y: 4.0, w: '45%', h: 3 }
...
function genSlide15(pptx) {
  ...
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html')
  slide.addTable(
    [[{ text: 'Chart Examples: Bubble Charts', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
  ...
  // BOTTOM-RIGHT
  const optsChartBubble4 = { x: 7.0, y: 4.0, w: '45%', h: 3, lineSize: 0, chartColors: COLORS_RYGU }
...
function genSlide16(pptx) {
  ...
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html')
  slide.addTable(
    [[{ text: 'Chart Examples: Radar Chart', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
...
function genSlide17(pptx) {
  ...
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html')
  slide.addTable(
    [[{ text: 'Chart Examples: Multi-Level Category Axes', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
...
function genSlide19(pptx) {
  ...
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html')
  slide.addTable(
    [[{ text: 'Chart Examples: Combo Chart', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
...
function genSlide20(pptx) {
  ...
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html')
  slide.addTable(
    [[{ text: 'Chart Examples: Combo Chart Options', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
...
function genSlide21(pptx) {
  ...
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html')
  slide.addTable(
    [[{ text: 'Misc Options: Shadow, Transparent Colors', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
...
function devSlide01(pptx) {
  const slide = pptx.addSlide({ sectionTitle: 'Charts-DevTest' })
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html')
  slide.addTable(
    [
      [
        { text: 'DEV-TEST: lots-of-bars (>26 letters); negative val check', options: BASE_TEXT_OPTS_L },
        BASE_TEXT_OPTS_R,
      ],
    ],
    BASE_TABLE_OPTS,
...
function devSlide07(pptx) {
  ...
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-charts.html')
  slide.addTable(
    [[{ text: 'DEV-TEST: title-options & inverted-colors', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
