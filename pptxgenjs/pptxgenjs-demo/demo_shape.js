const { BASE_TABLE_OPTS, BASE_TEXT_OPTS_L, BASE_TEXT_OPTS_R } = require('./enums')

function genSlidesShape(pptx) {
...
function genSlide01(pptx) {
  const slide = pptx.addSlide({ sectionTitle: 'Shapes' })

  slide.addTable(
    [[{ text: 'Shape Examples 1: Misc Shape Types (no text)', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
  ...
  slide.addShape(pptx.shapes.OVAL, {
    ...
    w: 3.0,
    h: 1.5,
    fill: { type: 'solid', color: pptx.colors.ACCENT2 },
  })
  ...
  slide.addShape(pptx.shapes.LINE, {
    ...
    w: 5.0,
    h: 0.0,
    line: { color: pptx.colors.ACCENT2, width: 3, endArrowType: 'triangle' },
  })
  slide.addShape(pptx.shapes.LINE, {
    x: 4.2,
    y: 5.6,
...
function genSlide02(pptx) {
  ...
  slide.addTable(
    [[{ text: 'Shape Examples 2: Misc Shape Types (with text)', options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]],
    BASE_TABLE_OPTS,
  )
  slide.addNotes('API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-shapes.html')
